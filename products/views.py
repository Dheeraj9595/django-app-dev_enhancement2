...
class QRRequestFormView(AdminLoginRequiredMixin, GroupRequiredMixin, View):
    ...
    def get(self, request):
        ...
        formset = self.formset_class()  # form_kwargs={"user": request.user}
...
#     # Query all products and retrieve product name, QR code image URL, and campaign name
#     products_list = Product.objects.exclude(qr_code_img_url__isnull=True).exclude(qr_code_img_url='').values('id',
#                                                                                                              'product_name',
#                                                                                                              'qr_code_img_url',
#                                                                                                              'campaign_name_id',
#                                                                                                              'brand',
...
#                                                                                                              'requested_date')
#
#     # Retrieve campaign names based on campaign IDs
...
#
#     # Initialize paginator with products list and set number of products per page
...
#                                                                                                              'requested_date')
#
#     # Extract the brand codes from the queryset result
#     # brand_codes = [brand[1] for brand in brand_codes]
#
#     # Retrieve campaign names based on campaign IDs
#     for product in products_list:
#         campaign_id = product['campaign_name_id']
...
#
#     if brand_code:
#         products_list = products_list.filter(brand__brand_code__icontains=brand_code)
#     if local_brand_name:
